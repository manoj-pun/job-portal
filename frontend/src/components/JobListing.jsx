...
const JobListing = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-1'>
      {/* Sidebar */}
      <div className='w-full lg:w-1/4 bg-white px-4'>
        ...
        <div className={showFilter ? "" : "max-lg:hidden"}>
            <h4 className='font-medium text-lg py-2'>Search By Categories</h4>
        ...
        {/* Location Filter */}
        <div className={showFilter ? "" : "max-lg:hidden"}>
            <h4 className='font-medium text-lg py-2 pt-14'>Search By Location</h4>
            <ul className='space-y-1 text-gray-600'>
