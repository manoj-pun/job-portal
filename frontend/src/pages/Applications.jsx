...
const Applications = () => {
  ...
  const updateResume = async () => {
    try {
      ...
      const {data} = await axios.post(backendUrl+"/api/users/update-resume",formData,{headers:{token:userToken}})
        ...
        <div className='flex gap-2 mb-6 mt-3'>
          {
            ...
            : <div className='flex gap-2'>
              <a href={userData.resume} target='_blank' className='bg-blue-100 text-blue-600 px-4 py-2 rounded'>Resume</a>
